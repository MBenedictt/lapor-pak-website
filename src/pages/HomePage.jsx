    ...
    return (
        <div>
            ...
            <div className="w-full h-screen flex items-center justify-center bg-white px-30 max-[1280px]:px-20 max-md:px-10 max-md:py-10 max-[991px]:h-auto max-[991px]:mt-[70px] max-[991px]:py-20 max-sm:px-5">
                <div className="flex max-[991px]:flex-col-reverse justify-between items-center w-full gap-10">
                    <div className="w-7/12 max-[991px]:w-full mb-10 md:mb-0 max-sm:px-5">
                        <h1 className="text-5xl max-sm:text-4xl font-bold text-black mb-6 max-sm:text-center leading-[60px] max-sm:leading-[50px]" data-aos="fade-right" data-aos-once="true">
                            lapor<span className="text-red-600">PAK</span> by <span className="text-red-600">City Department®</span>
                        </h1>
                        <p className="text-gray-700 mb-8 leading-relaxed max-sm:text-center" data-aos="fade-right" data-aos-once="true">
                    ...
                    <div className="w-5/12 max-[991px]:w-full flex justify-center relative">
                        <div className="relative w-96 h-96 max-lg:w-72 rounded-full max-lg:h-72 overflow-hidden" data-aos="fade-left" data-aos-once="true">
                            <img
            ...
            <div className="bg-red-50 w-full px-30 max-[1280px]:px-20 py-20 max-md:px-10 max-md:py-10 flex flex-col items-center justify-center">
                <h1 className="text-5xl font-bold text-black text-center mb-15 max-sm:text-4xl max-sm:mb-10" data-aos="fade-down" data-aos-once="true">Cara Membuat Laporan</h1>
                <div className="w-full grid grid-cols-3 gap-5 max-[991px]:grid-cols-1">
                    <div className="flex flex-col items-center">
                        <div className="w-60 h-60 xl:w-72 xl:h-72 rounded-full overflow-hidden mx-auto border-6 border-rose-200 shadow-lg mb-2 hover:scale-105 transition duration-300" data-aos="zoom-in" data-aos-once="true">
                            <img
                        ...
                        <div className="w-60 max-[991px]:w-2/4 max-sm:w-full flex flex-col justify-center text-center items-center" data-aos="fade-up" data-aos-once="true">
            ...
            <div className="w-full px-30 max-[1280px]:px-20 py-20 max-md:px-10 max-sm:px-5 max-md:py-10">
                <div className="flex justify-between items-center mb-15 max-sm:mb-10 max-sm:flex-col">
                    <h1 className="text-5xl font-bold text-black max-sm:text-4xl max-sm:mb-5 max-sm:text-center pb-2" data-aos='fade-right' data-aos-once="true">Laporan Teratas</h1>
                    <Link to="/report" data-aos='fade-left' data-aos-once="true">
                ...
                <div className="flex justify-center items-center">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" data-aos="fade-up" data-aos-once="true">
            ...
            <div className="w-full px-6 py-10 flex flex-col items-center justify-center bg-red-50">
                <h1 className="text-5xl font-bold text-black text-center mb-10 max-sm:text-4xl max-sm:mb-6" data-aos="fade-down" data-aos-once="true">
                    Ringkasan Laporan
                </h1>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-7xl">
                    <div className="bg-white rounded-2xl shadow-md p-6 w-full" data-aos="slide-up" data-aos-once="true">
                    ...
                    {/* Card 2 */}
                    <div className="bg-white rounded-2xl shadow-md p-6 w-full" data-aos="slide-up" data-aos-once="true" ref={chartContainerRef}>
                        <h2 className="text-xl md:text-2xl font-bold text-black text-center mb-4 md:mb-5 lg:mb-6">
